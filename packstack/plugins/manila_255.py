...
def initConfig(controller):
    conf_params = {
        ...
        "MANILAGLUSTERNATIVE": [
            ...
            {"CMD_OPTION": "glusterfs-native-server-password",
             "PROMPT": ("Enter password for GlusterFS servers"),
             "OPTION_LIST": [],
             "VALIDATORS": [],
             "DEFAULT_VALUE": "",
             "MASK_INPUT": True,
             "LOOSE_VALIDATION": False,
             "CONF_NAME": "CONFIG_MANILA_GLUSTERFS_NATIVE_SERVER_PASSWORD",
             "USE_DEFAULT": False,
             "NEED_CONFIRM": True,
             "CONDITION": False},
        ...
        "MANILAGLUSTERNFS": [
            ...
            {"CMD_OPTION": "glusterfs-server-password",
             "PROMPT": ("Enter password for GlusterFS server"),
             "OPTION_LIST": [],
             "VALIDATORS": [],
             "DEFAULT_VALUE": "",
             "MASK_INPUT": True,
             "LOOSE_VALIDATION": False,
             "CONF_NAME": "CONFIG_MANILA_GLUSTERFS_SERVER_PASSWORD",
             "USE_DEFAULT": False,
             "NEED_CONFIRM": False,
             "CONDITION": False},
            ...
            {"CMD_OPTION": "glusterfs-ganesha-server-username",
             "PROMPT": ("Enter username for GlusterFS ganesha server"),
             "OPTION_LIST": [],
             "VALIDATORS": [],
             "DEFAULT_VALUE": "",
             "MASK_INPUT": False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME": "CONFIG_MANILA_GLUSTERFS_GANESHA_SERVER_USERNAME",
             "USE_DEFAULT": False,
             "NEED_CONFIRM": False,
             "CONDITION": False},

            {"CMD_OPTION": "glusterfs-ganesha-server-password",
             "PROMPT": ("Enter password for GlusterFS ganesha server"),
             "OPTION_LIST": [],
             "VALIDATORS": [],
             "DEFAULT_VALUE": "",
             "MASK_INPUT": True,
             "LOOSE_VALIDATION": False,
             "CONF_NAME": "CONFIG_MANILA_GLUSTERFS_GANESHA_SERVER_PASSWORD",
             "USE_DEFAULT": False,
             "NEED_CONFIRM": False,
             "CONDITION": False},
        ],
